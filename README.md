...
- `markdown_extras` is a list of extras for markdown2 module. this list will be passed to markdown filter which will extend the abilities of markdown interpreter. Secretary supports `fenced-code-blocks`.
...
There is two ways of creating code blocks:
1. The official way:
...
- Fenced Code Blocks. this is the only way to activate the true code Highlighting:
